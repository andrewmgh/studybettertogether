...
if(($_SERVER['PHP_SELF']) != "/studybettertogether/includes/db/db_connect.php"){
	...
	// if the database connection fails, the error number and error message is displayed on the screen along with a prompt to email the site administrator for help.
	if (!$db_con) {
