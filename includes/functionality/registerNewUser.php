...
if ($_SERVER['REQUEST_METHOD']== "POST") 
{
		...
		validateRegistrationForm ($db_con, $_POST ['firstname'], $_POST ['lastname'], $_POST ['email'], $_POST ['username'], $_POST ['password'], $_POST ['password_confirm'], $_POST ['register_code']);
	...
	exit();
		...
		function validateRegistrationForm ($db_con, $firstName, $lastName, $email, $userName, $password, $password_confirm, $register_code){
